            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                     ...
                     <!-- /.box-header -->
                     <!-- form start -->
                     <form action="<?php echo base_url()?>Admin/save_restaurant" method="post" enctype="multipart/form-data" onsubmit="return validation();">
                      ...
                      <input type="hidden" id="lang" name="lng">
                        <div class="box-body">
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="restaurant_name" value="<?php echo set_value('restaurant_name'); ?>" class="form-control"/>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="">Restaurant Offical Email:<span class="text-danger">*</span></label>
                                    <input type="text" name="restaurant_email" value="<?php echo set_value('restaurant_email'); ?>" class="form-control"/>
                             ...
                             <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="number" name="number_of_table" maxlength="10" value="<?php echo set_value('number_of_table'); ?>" class="form-control"/>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="freemobile" maxlength="13" name="mobile" value="<?php echo set_value('mobile'); ?>" class="form-control"/>
                           ...
                           <div class="row">
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="openTime" name="openTime" value="<?php echo set_value('openTime'); ?>" class="form-control basicExample"/>
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="closeTime" name="closeTime" value="<?php echo set_value('closeTime'); ?>" class="form-control basicExample"/>
