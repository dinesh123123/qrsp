  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <?php echo $title; ?>
          ...
          <div class="col-md-3">
         <?php if($qr_code){ ?>
                                <iframe src="<?php echo base_url()?>/Genrate/generate_pdf_code_two" name="frame" style="display:none;"></iframe>
              ...
              <?php $a=1;  foreach ($qr_code as $row) { ?>
                ...
                <!--  </td>-->
                 ...
                 <td><?php echo ($row['created_time']);?> </td>
                  <td>
                      <?php echo anchor('Genrate/two_time_delete/'.$row['id'], '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
                  </td> 
                </tr>
                <?php }?>
                </tbody>
