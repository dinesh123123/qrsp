				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<!-- form start -->
							<form action="<?php echo base_url()?>Genrate/update_qr_code/<?php echo $qr_code['id']  ;?>" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="row">
...
<div class="col-md-9">
										...
										?>
											...
											<div class="form-group">
												...
												<input style="color: #3c8dbc;" type="number"  value="<?php echo $qr_code['unique_id'] ;?>" id="numberField" name="unique_id" class="form-control" placeholder="Enter Unique Number Only" disabled/>
												<?php echo form_error('tables', '<div class="error">', '</div>'); ?>
											</div>
										</div>
