				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form action="<?php echo base_url()?>Genrate/reset_qr_genrate" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="row">
										<div class="col-md-6">
										...
										?>
											...
											<div class="form-group">
												<label class="">Multiple Qr Genrate : <span class="text-danger">*</span></label>
												<input type="number" id="numberField" name="unique_id" class="form-control" placeholder="Enter Number Only" required />
