...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
            ...
            <!--    <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');"><i class="fa fa-plus"></i> Two_DataUpdate</a>-->
           
            <!-- <?php if($fetch_infinite){?>-->
            <!--    <a style="font-size: 14px; margin-right: 72%;" href="<?php echo base_url()?>Genrate/two_qr_genrate" class="btn btn-warning btn-sm pull-right "><i class="fa fa-qrcode"></i> QR Two Genrate</a>-->
            <!--    <?php }else{ ?>-->
            ...
            <div id="importFrm" style="display: none;">
              ...
              <form class="form-inline" action="<?php echo base_url();?>Genrate/importUpdate_two" method="post" enctype="multipart/form-data">
...
<input class="btn btn-primary" type="submit" name="submit" value="Upload" />
							...
							<form action="<?php echo base_url()?>Genrate/add_qr_infinite" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="">Code Start : <span class="">*</span></label>
												<!--<input type="number"  id="numberunit" name="unit" class="form-control" placeholder="Enter Unit Number " />-->
												<input  name="code_start" type="datetime-local" value="" class="form-control" required>
												<?php echo form_error('tables', '<div class="error">', '</div>'); ?>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="">Code End : <span class="">*</span></label>
												<!--<input type="number"  id="numberunit" name="unit" class="form-control" placeholder="Enter Unit Number " />-->
													<input  name="code_end" type="datetime-local" value="" class="form-control" required>
												<?php echo form_error('tables', '<div class="error">', '</div>'); ?>
											</div>
										</div>
						...
						<textarea class="form-control" name="title" placeholder="Enter Title" rows="3" required ></textarea>
							</div>
						</div>
						...
						<textarea class="form-control" name="information" placeholder="Enter Information /Link " rows="5" ></textarea>
								...
								<div class="box-footer">
									<input type="submit" class="btn btn-primary" name="submit" value="Add Infinite QR"/>
