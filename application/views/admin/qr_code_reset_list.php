	...
	<div class="content-wrapper"> 
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo base_url()?>Genrate/qr_code_reset" class="btn btn-primary btn-sm pull-right ">QR Reset Add</a></li>
							...
							<?php $a=1;  foreach ($qr_code as $row) { ?>
								...
								<?php  } ?>
								 ...
								 <td>
											...
											<a class="btn btn-warning" href="<?php echo base_url(); ?>Genrate/qr_code_reset_edit/<?php echo $row['id'] ; ?>"><i class="fa fa-edit"></i></a>
