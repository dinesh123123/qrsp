        ...
        echo $this->session->flashdata('success_req'); ?>
          <div class="box box-primary">
            ...
            <div class="table-responsive" style="overflow-x:auto;">
              ...
              <?php if($scan){ $a=1;  foreach ($scan as $row) { ?>
                <tr>
                ...
                <!--  </td>-->
                  ...
                  <td class="center">
                    ...
                    <img src="<?php echo base_url()?><?php echo $row['qr_code'];?>" height=50px width=50px>
                  <?php } else{ ?>
                    <img src="<?php echo base_url()?>assets/qr_image/qrimage.jpg" height=50px width=50px>
                <?php  } ?>
                  </td>
                  <td><?php echo ucwords($row['unique_id']);?></td>
                  <td><?php echo ucwords($row['qr_type']);?></td>
