		...
		<div class="content-wrapper">
			...
			<section class="content">
              ...
              <div class="float-right">
                <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');"><i class="fa fa-plus"></i> DataUpdate</a>
            </div>
            <div id="importFrm" style="display: none;">
                <h3 class="box-title">Upload excel file</h3>
              <form class="form-inline" action="<?php echo base_url();?>Genrate/importUpdate" method="post" enctype="multipart/form-data">
...
<input class="btn btn-primary" type="submit" name="submit" value="Upload" />
							...
							<form action="<?php echo base_url()?>Genrate/add_qr" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="row">
										<div class="col-md-6">
						...
						<textarea class="form-control" name="information" placeholder="Enter Information /Link " rows="5" ></textarea>
								...
								<div class="box-footer">
									<input type="submit" class="btn btn-primary" name="submit" value="Add QR"/>
