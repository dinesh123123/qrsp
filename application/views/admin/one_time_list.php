  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <?php echo $title; ?>
          ...
          <div class="col-md-3">
         <?php if($qr_code){ ?>
                                <iframe src="<?php echo base_url()?>/Genrate/generate_pdf_code_one" name="frame" style="display:none;"></iframe>
...
<!--<a style="" href="<?php echo base_url()?>Admin/generate_pdf_one" class="btn btn-warning btn-sm pull-right "><i class="fa fa-qrcode"></i> QR One Genrate</a>-->
      <br>
      <ol class="breadcrumb">
              ...
              <?php $a=1;  foreach ($qr_code as $row) { ?>
                ...
                <!--  </td>-->
                 ...
                 <td><?php echo ($row['created_time']);?> </td>
                  <td>
                      <?php echo anchor('Genrate/one_time_delete/'.$row['id'], '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
                  </td> 
                </tr>
                <?php }?>
                </tbody>
