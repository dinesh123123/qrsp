...
<aside class="main-sidebar">
 ...
 <li style='margin-left: -3px;' data-toggle="collapse" data-target="#List" >
                  <a href="#"><i class="fa fa-qrcode"  style='margin-left: 4px;'  ></i>QR List  <span class="arrow"></span></a>
                </li>
                <ul class="sub-menu collapse" id="List">
...
<li  style='margin-left: -3px;' data-toggle="collapse" data-target="#Generation" class="">
                  <a href="#"><i class="fa fa-qrcode" style='margin-left: 4px;' ></i>QR Generation  <span class="arrow"></span></a>
                </li>
                <ul class="sub-menu collapse" id="Generation">
    ...
    <li><a href="<?php  echo base_url()?>Genrate/qr_code_reset_list"><i style='' class="fa fa-qrcode">
       
    </i> Reset Generation</a></li>
...
<li  style='margin-left: -3px;' data-toggle="collapse" data-target="#Gallery" class="">
                  <a href="#" style='margin-left: 4px;' ><i class="fa fa-image"></i> Gallery <span class="arrow"></span></a>
                </li>
