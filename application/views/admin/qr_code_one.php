	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
              ...
              <div >
                <a href="javascript:void(0);" class="btn btn-success" onclick="formToggle('importFrm');"><i class="fa fa-plus"></i>One_DataAdd</a>
                <?php if($fetch_one){?>
                <a style="font-size: 14px; margin-right: 72%;" href="<?php echo base_url()?>Genrate/one_qr_genrate" class="btn btn-warning btn-sm pull-right "><i class="fa fa-qrcode"></i> QR One Genrate</a>
                <?php }else{ ?>
            ...
            <div id="importFrm" style="display: none;">
              ...
              <form class="form-inline" action="<?php echo base_url();?>Genrate/importUpdate_one" method="post" enctype="multipart/form-data">
...
<input class="btn btn-primary" type="submit" name="submit" value="Upload" />
							...
							<form action="<?php echo base_url()?>Genrate/add_qr_one" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="row">
										<div class="col-md-6">
						...
						<textarea class="form-control" name="information" placeholder="Enter Information /Link " rows="5" ></textarea>
								...
								<div class="box-footer">
									<input type="submit" class="btn btn-primary" name="submit" value="Add One QR"/>
